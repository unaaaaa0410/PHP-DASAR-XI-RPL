...
<div class="container-fluid bg-primary-subtle d-flex align-items-center justify-content-center" style="height: 100vh;" > 
	<div class="card p-3 col-lg-6" style="border-radius: 15px">
		<div class="row">
		<div class="kiri col-lg-4 bg-primary">
		<img src="leaaa.jpg" class="img-fluid col-12 rounded">
	</div>
		...
		<div class="col-12 py-3">
			...
			<span class="badge rounded-pill text-bg-secondary">perhotelan</span>
			<span class="badge rounded-pill text-bg-success">TJKT</span>
		</div>
		<div class="row">
			<div class="col-8">
